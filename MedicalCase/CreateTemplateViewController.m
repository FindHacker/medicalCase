...
-(void)saveTemplateToCoreData
{
   ...
   // __block NSDictionary *tempD = [[NSDictionary alloc] init];
    ...
    [http postTemplateToServerWithDicParam:param success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        ///save to core data
       // NSDictionary *tempDD = NSDictionaryOfVariableBindings(condition,content,ageLow,ageHigh,gender,admittingDiagnosis,simultaneousPhenomenon,cardinalSymptom,nodeID,updatedTime);
//        tempD = [NSDictionary dictionaryWithDictionary:tempDD];
//        
//        [self.coreDataStack createManagedObjectTemplateWithDic:tempD ForNodeWithNodeName:self.title];
//        [self.coreDataStack createManagedObjectTemplateWithDic:tempD ForNodeWithNodeName:self.title];
